          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-green-600 text-xs font-medium">+1.2K</span>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-yellow-600 text-xs font-medium">Meeting</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900">Content Review</p>
                  <p className="text-xs text-gray-500">Friday at 2:00 PM</p>
                </div>
                <span className="text-blue-600 text-xs font-medium">Review</span>
              </div>
            </div>
          </div>
        </div>
